...
assert.ok(instant.equals(Temporal.Instant.from(result)));
...
assert.ok(instant.equals(Temporal.Instant.from(result2)));
...
assert.ok(instant.equals(Temporal.Instant.from(result3)));
assert.ok(zoned.equals(Temporal.ZonedDateTime.from(result3)));
