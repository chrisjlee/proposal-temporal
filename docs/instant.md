...
```js
instant = Temporal.Instant.from('2019-03-30T00:45Z');
new Date(instant.epochMilliseconds).toISOString(); // => '2019-03-30T00:45:00.000Z'
```
...
instant.toLocaleString(); // => '11/18/2019, 3:00:00 AM'
  // (if host environment's current locale is 'en-US')
instant.toLocaleString('de-DE'); // => '18.11.2019, 03:00:00'
